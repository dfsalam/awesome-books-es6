...
**Awesome Books ES6** is a basic JavaScript project to understand the basics of modules and ES6 syntax. 
...
```
git clone https://github.com/dfsalam/awesome-books-es6.git
```
...
To run the project, if you are on the awesome-books-es6 folder path on your terminal you can execute the following command:
...
Feel free to check the [issues page](https://github.com/dfsalam/awesome-books-es6/issues).
